...
@Component({
  selector: 'app-volleyball-news',
  templateUrl: './volleyball-news.component.html',
  styleUrls: ['./volleyball-news.component.css'],
  standalone: true,
...
export class VolleyballNewsComponent implements OnInit {
  articles: Article[] = [];
  ...
  fetchNews(): void {
    this.http.get<any>('https://newsapi.org/v2/everything?q=voleibol&language=es&apiKey=e7493892f4d24c76a5c8357e62c27c5c')
      .subscribe(data => {
