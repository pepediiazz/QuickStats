...
@Component({
  selector: 'app-baseball-news',
  templateUrl: './baseball-news.component.html',
  styleUrls: ['./baseball-news.component.css'],
  standalone: true,
...
export class BaseballNewsComponent implements OnInit {
  articles: Article[] = [];
  ...
  fetchNews(): void {
    this.http.get<any>('https://newsapi.org/v2/everything?q=beisbol&language=es&apiKey=e7493892f4d24c76a5c8357e62c27c5c')
      .subscribe(data => {
