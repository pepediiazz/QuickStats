...
@Component({
  selector: 'app-basketball-news',
  templateUrl: './basketball-news.component.html',
  styleUrls: ['./basketball-news.component.css'],
  standalone: true,
...
export class BasketballNewsComponent implements OnInit {
  articles: Article[] = [];
  ...
  fetchNews(): void {
    this.http.get<any>('https://newsapi.org/v2/everything?q=baloncesto&language=es&apiKey=e7493892f4d24c76a5c8357e62c27c5c')
      .subscribe(data => {
