...
@Component({
  ...
  templateUrl: './rugby-carousel.component.html',
  styleUrls: ['./rugby-carousel.component.css'],
  animations: [
    trigger('slideInOut', [
...
export class RugbyCarouselComponent implements OnInit {
  games: Game[] = [];
  ...
  getGames(): void {
    ...
    this.rugbyService.getRugbyByDate(today).subscribe(
      data => {
